function present_pause(window, INFO, t)
...
Screen(window,'FillRect', P.stim.background_color);
...
Screen(window,'DrawText', pausetext, cx-0.5*tw, cy-2*th, P.stim.fix_color);
% my_fixationpoint(window, P.CenterX, P.CenterY, P.FixSize, P.FixColor)
my_optimal_fixationpoint(window, cx, cy, P.stim.fix_size, P.stim.fix_color, ...
    P.stim.background_color, P.screen.pixperdeg)
